...
# Add the absolute path of the root project directory (EDR_Solution)
sys.path.append(os.path.abspath('D:/EDR_Solution'))
from alert_message.desktop_alert import DesktopAlert
...
class MonitorCpuSpike():
    ...
    def generate_alert(self, processes):
        ...
        alert = DesktopAlert(title=title, msg=msg)
        alert.show_alert()
